...
import {
    Users, CreditCard, Save, ArrowLeft, Waves, Ticket,
    Plus, Minus, Smartphone, Banknote, Landmark, Globe
} from 'lucide-react';
            ...
            <form onSubmit={handleSell} className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-6 bg-white border-2 border-gray-100 rounded-3xl flex items-center justify-between shadow-sm">
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-cyan-100 text-cyan-600 rounded-2xl"><Users size={24} /></div>
                                <div>
                    ...
                    <div className="space-y-2 px-1">
                        ...
                        <input
                            type="text"
                            placeholder="e.g. Jane Smith / Hotel Guest"
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {[
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center gap-2 p-4 rounded-2xl border-2 transition-all ${paymentMethod === method.id ? 'border-[var(--color-primary)] bg-orange-50 text-orange-700 shadow-sm' : 'border-gray-100 hover:border-gray-200 text-gray-400'}`}
                            >
                                {method.icon}
                ...
                <div className="bg-gray-900 p-8 rounded-[2.5rem] shadow-2xl space-y-6">
                    <div className="flex justify-between items-center text-white">
                        <div>
                            <div className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--color-primary)] mb-1">Total Payable</div>
                    ...
                    <button
                        ...
                        type="submit"
                        className="w-full bg-[var(--color-primary)] text-white py-6 rounded-2xl font-black uppercase tracking-[0.2em] text-sm hover:bg-orange-600 transition-all shadow-lg shadow-orange-900/20 flex items-center justify-center gap-3 disabled:opacity-50"
                    >
