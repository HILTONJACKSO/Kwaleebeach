...
import {
    ...
    Utensils, ChevronLeft, Save, Upload, Check, Trash2
} from 'lucide-react';
...
export default function EditMenuItemPage() {
    ...
    useEffect(() => {
        const loadPageData = async () => {
            await Promise.all([fetchCategories(), fetchInventoryItems(), fetchItemData()]);
            setFetching(false);
        };
        loadPageData();
    }, [id]);
        ...
        try {
            ...
            if (res.ok) {
                ...
                setFormData({
                    ...
                    preparation_station: data.preparation_station,
                    inventory_item: data.inventory_item ? data.inventory_item.toString() : '',
                    is_available: data.is_available
                });
                if (data.image) {
                    setPreviewUrl(data.image); // This will be the absolute URL from the backend
                }
            }
        } catch (e) {
            ...
            <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <h1 className="text-4xl font-black text-gray-900 tracking-tight">Edit Item</h1>
                        <p className="text-gray-500 font-medium">{formData.name}</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm space-y-6">
                            <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 block text-center">Update Image</label>
